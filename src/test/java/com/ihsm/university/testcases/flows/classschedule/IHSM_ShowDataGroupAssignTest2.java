...
public class IHSM_ShowDataGroupAssignTest2 extends BaseClass {

	private WebDriver driver;

	public IHSM_ShowDataGroupAssignTest2(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void showDataofGroupAssignment() {
		...
		try {
			...
			data.fillFacultyShowData("2026 -2027", "1", "CENTRAL / Bachelor / MBBS", "1", "Демонстрационный факультет (Demo Faculty)");
