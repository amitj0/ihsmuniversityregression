...
import com.ihsm.university.testcases.flows.classschedule.IHSM_ShowDataGroupAssignTest2;
...
public class IHSM_ClassScheduling4 extends BaseClass {
	...
	public void verifyClassScheduling() throws InterruptedException {
		...
		IHSM_ShowDataGroupAssignTest2 data = new IHSM_ShowDataGroupAssignTest2(getDriver());
